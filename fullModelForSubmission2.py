...
clf_SVM_Tar.fit(tc_target_train, train_labels)
clf_SVM_Pre.fit(tc_pre_train, train_labels)


train_df["pre_predict-A"] = train_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Tar.predict_proba(x)[0][0])
train_df["pre_predict-B"] = train_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Tar.predict_proba(x)[0][1])
train_df["pre_predict-N"] = train_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Tar.predict_proba(x)[0][2])
train_df["tar_predict-A"] = train_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Pre.predict_proba(x)[0][0])
train_df["tar_predict-B"] = train_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Pre.predict_proba(x)[0][1])
train_df["tar_predict-N"] = train_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Pre.predict_proba(x)[0][2])
...
clfANN = MLPClassifier(activation='relu', alpha=1e-05, batch_size='auto',
           ...
           epsilon=1e-05, hidden_layer_sizes=(500,200,200),
...
test_df["pre_predict-A"] = test_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Pre.predict_proba(x)[0][0])
test_df["pre_predict-B"] = test_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Pre.predict_proba(x)[0][1])
test_df["pre_predict-N"] = test_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Pre.predict_proba(x)[0][2])
test_df["tar_predict-A"] = test_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Tar.predict_proba(x)[0][0])
test_df["tar_predict-B"] = test_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Tar.predict_proba(x)[0][1])
test_df["tar_predict-N"] = test_df["CVlemmTextPreceding"].apply(lambda x: clf_SVM_Tar.predict_proba(x)[0][2])
...
finaldf.to_csv('submissionWModel2.csv', index=False, sep=',', encoding='utf-8')
